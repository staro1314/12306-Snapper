...
export interface TicketQueryResult { source: "12306_OFFICIAL_READ_ONLY"; path: string; status: number; success?: boolean; compatible?: boolean; classification?: string; resultCount?: number; queryId?: string; candidates?: TicketQueryCandidate[]; }
